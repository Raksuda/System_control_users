...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="POST" action="{{ url('/addPro')}}">
        {{ csrf_field() }}
        <h2 class="form-signin-heading">กรุณากรอกชื่อจังหวัด</h2>
        
        <input type="text" name="inputPro" class="form-control" placeholder="" required autofocus>
